#ifndef SYSMEL_ENVIRONMENT_AST_SEMANTIC_ANALYZER_HPP
#define SYSMEL_ENVIRONMENT_AST_SEMANTIC_ANALYZER_HPP
#pragma once
...
public:
    ...
    TypeConversionCost rankForMatchingTypeWithNode(const TypePtr &expectedType, const ASTNodePtr &node, bool isReceiverType = false);
...
#endif //SYSMEL_ENVIRONMENT_AST_SEMANTIC_ANALYZER_HPP