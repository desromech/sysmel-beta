...
SYSMEL_DECLARE_BOOTSTRAP_CLASS(SSAEvaluatePatternInstruction);
SYSMEL_DECLARE_BOOTSTRAP_CLASS(SSAFailPatternInstruction);
SYSMEL_DECLARE_BOOTSTRAP_CLASS(SSATrapInstruction);
